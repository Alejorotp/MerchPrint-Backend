...
import {
  Company,
  CompanySchema,
} from '../../../infrastructure/companies/mongoose/company.schema';
import { CompaniesController } from './companies.controller';
import { CompaniesRmqController } from '../../rmq/companies.rmq.controller';
...
} from '../../../application/companies/usecases/exists-company.usecase';
  ...
  providers: [
    {
      ...
      useClass: useMongoose
        ? MongooseCompanyRepository
        : InMemoryCompanyRepository,
    },
    {
      provide: CreateCompanyUseCase,
      useFactory: (repo: any) => new CreateCompanyUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: GetCompanyUseCase,
      useFactory: (repo: any) => new GetCompanyUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: UpdateCompanyUseCase,
      useFactory: (repo: any) => new UpdateCompanyUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: DeleteCompanyUseCase,
      useFactory: (repo: any) => new DeleteCompanyUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: GetAllCompaniesUseCase,
      useFactory: (repo: any) => new GetAllCompaniesUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: ExistsCompanyByNameUseCase,
      useFactory: (repo: any) => new ExistsCompanyByNameUseCase(repo),
      inject: [COMPANY_REPOSITORY],
    },
    {
      provide: ExistsCompanyByIdUseCase,
